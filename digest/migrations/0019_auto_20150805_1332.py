...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='autoimportresource',
            name='language',
            field=models.CharField(verbose_name='Язык источника',
                                   max_length=2,
                                   default='en',
                                   choices=[('ru', 'Русский'),
                                            ('en', 'Английский')]), ),
        migrations.AlterField(
            model_name='autoimportresource',
            name='type_res',
            field=models.CharField(verbose_name='Тип источника',
                                   max_length=255,
                                   default='twitter',
                                   choices=[('twitter',
                                             'Сообщения аккаунтов в твиттере'),
                                            ('rss', 'RSS фид')]), ),
        migrations.AlterField(model_name='issue',
                              name='image',
        ...
        migrations.AlterField(
            model_name='item',
            name='language',
            field=models.CharField(verbose_name='Язык новости',
                                   max_length=2,
                                   default='en',
                                   choices=[('ru', 'Русский'),
                                            ('en', 'Английский')]), ),
        ...
        migrations.AlterField(
            model_name='parsingrules',
            name='if_element',
            field=models.CharField(verbose_name='Элемент условия',
                                   max_length=255,
                                   default='item_title',
        ...
        migrations.AlterField(
            model_name='parsingrules',
            name='then_action',
            field=models.CharField(verbose_name='Действие',
                                   max_length=255,
                                   default='item_title',
                                   choices=[('set', 'Установить'), (
                                       'add', 'Добавить'
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                ...
                max_length=255,
                default='item_title',
                choices=[('title', 'Заголовок новости'), ('section', 'Раздел'),
                         ('status', 'Статус'), ('tags', 'Тэг новости')]), ),
        migrations.AlterField(
            model_name='section',
            name='status',
            field=models.CharField(verbose_name='Статус',
                                   max_length=10,
                                   default='active',
                                   choices=[('pending', 'Ожидает проверки'),
                                            ('active', 'Активный')]), ),
    ]
