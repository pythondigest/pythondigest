...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Item.is_editors_choice'
        db.add_column(u'digest_item', 'is_editors_choice',
    ...
    def backwards(self, orm):
        # Deleting field 'Item.is_editors_choice'
        db.delete_column(u'digest_item', 'is_editors_choice')
