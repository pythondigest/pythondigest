...
class AutoImportResourceTest(TestCase):
    def test_filter(self):
        ...
        self.create_resource(title="test2", type_res='rss', link='https://python3.ru')
        self.create_resource(title="test3", in_edit=True, link='https://python7.ru')
        self.create_resource(title="test4", type_res='rss', in_edit=True, link='https://python4.ru')
    ...
    def test_resource_type_res(self):
        ...
        resource = self.create_resource(title="Test2", type_res='rss', link='https://python.ru2')
        self.assertEqual(resource.type_res, 'rss')
